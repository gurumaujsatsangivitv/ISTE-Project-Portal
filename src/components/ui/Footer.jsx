    ...
    <footer className="bg-black text-white py-8 w-full">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="text-left mb-6 md:mb-0">
          ...
          <div className="mt-4">
            <a href="mailto:iste@vit.ac.in" className="block text-white hover:underline">
              iste@vit.ac.in
            </a>
            <p className="mt-1">+91 70114 22095</p>
          </div>
        </div>

        {/* Social Media Section */}
        <div className="flex flex-col items-center md:items-end">
          <div className="flex space-x-5 text-3xl mb-4">
            <a href="https://www.instagram.com/iste_vit_vellore/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400"><AiFillInstagram /></a>
            <a href="https://x.com/iste_vitvellore" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400"><FaXTwitter /></a>
            <a href="https://www.linkedin.com/company/indian-society-for-technical-education/mycompany/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400"><FaLinkedin /></a>
            <a href="https://github.com/ISTE-VIT" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400"><IoLogoGithub /></a>
            <a href="https://www.youtube.com/@ISTEVITVellore" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400"><FaYoutube /></a>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-600 mt-6 pt-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          {/* Footer Credits */}
          <div className="flex items-center mt-4 md:mt-0 text-center">
            <span>Made with</span>
      ...
      <div className="relative w-full flex justify-center overflow-hidden pt-6">
